module github.com/ielboulo/ielboulo/interchaintest
...
replace (
	...
	// api breaking change patch
	github.com/cometbft/cometbft => github.com/cometbft/cometbft v0.38.10
